...
# Default command
CMD ["python3", "keyhound/main.py", "--web", "--config", "config/environments/production.yaml"]
...
CMD ["python3", "keyhound/main.py", "--web", "--gpu", "--config", "config/environments/production.yaml"]
